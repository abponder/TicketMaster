    ...
    for (var i = 0; i < ticketMasterRespondObjects.length; i++) {
        ...
        var thehtml = `
                 ...
                 <div class="card-body">
                     ...
                     <div class="col-5">
                         <p id="eventDatePar">${ticketMasterRespondObjects[i].date}</p>
                         <p id="eventMusicPar">${ticketMasterRespondObjects[i].genre} ${ticketMasterRespondObjects[i].segment}</p>
...
function scrollToCard(id) {
    ...
    $scrollTo.addClass('animated pulse bg-warning').one(animationEnd, function() {
        $(this).removeClass('animated pulse bg-warning');
